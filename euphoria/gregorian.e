...
global function fixed_to_gregorian(integer date)
    return gregorian_from_fixed(date)
end function
...
-- 2.24
--
global function gregorian_date_difference(sequence g_date1, sequence g_date2)
...
-- 2.25
--
global function day_number(sequence g_date)
    return gregorian_date_difference(
        gregorian_year_end(g_date[DATE_YEAR] - 1), 
        g_date)
end function
...
-- 2.26
--
global function days_remaining(sequence g_date)
    return gregorian_date_difference(
        g_date,
        gregorian_year_end(g_date[DATE_YEAR]))
end function
